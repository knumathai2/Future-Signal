...
const validContent = {
  ...
  conditional_scenarios: [
    { title: "조건 하나", narrative: "다".repeat(30), basis: "market_definition" },
    { title: "조건 둘", narrative: "라".repeat(30), basis: "observed_data" },
    { title: "조건 셋", narrative: "마".repeat(30), basis: "verified_context" },
  ],
  factors_to_check: [
    { title: "요인 하나", explanation: "바".repeat(20), basis: "market_definition" },
    { title: "요인 둘", explanation: "사".repeat(20), basis: "observed_data" },
  ],
  signals_to_watch: [
    { title: "자료 하나", explanation: "아".repeat(20), basis: "verified_context" },
    { title: "자료 둘", explanation: "자".repeat(20), basis: "observed_data" },
  ],
