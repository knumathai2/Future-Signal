...
|----|------|-------|----------|--------|--------|
| TASK-086 | Exact source-title occurrence validation | Data/AI Implementer | Data/AI Implementer | `data-ai/TASK-086-exact-title-validation` | assigned |
...
migration to any database. TASK-085 is complete and TASK-086 is next.
