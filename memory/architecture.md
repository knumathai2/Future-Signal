...
- Day 4 is active from this baseline with `TASK-040` and `TASK-018` remaining. Any shared or production schema application, paid external AI call, public API shape change, deployment, or infrastructure change remains separately approval-gated.
