...
| Data/AI | Existing v3 generation remains intact. TASK-058 provides bounded annotation-only research; TASK-059 adds deterministic provenance/date/entity/condition/source-independence gates and a different-provider, no-web verifier. Only verified candidates may flow to TASK-060. |
