...
- **Overall health**: 🟢 Good — Day 4 core UI/API/event-candidate work, report-generation code readiness, broad Korean live category filtering, and the 24h combined batch path are complete; OpenRouter-backed v2 summaries have been generated and verified for the default top-20 heat-sorted issues
